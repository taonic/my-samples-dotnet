...
public class SayHelloWorkflow
{
    ...
    public async Task<string> RunAsync(string name)
    {
        ...
        var result1 = await Workflow.ExecuteActivityAsync(
            ...
            new () { StartToCloseTimeout = TimeSpan.FromSeconds(10), TaskQueue = ActivityWorker1.Worker.TaskQueue });
        ...
        var result2 = await Workflow.ExecuteActivityAsync<string>(
            ...
            new () { StartToCloseTimeout = TimeSpan.FromSeconds(10), TaskQueue = "my-activity-task-queue-2" });
